...
<head>
    ...
    <title>Saberly - Acesso do Instrutor</title>
</head>
                        ...
                        <div class="card shadow-none bg-transparent rounded-0 mb-0">
                            <div class="card-body">
                                <img src="{{ asset('backend/assets/images/login-images/login-cover.svg') }}"
                                    ...
                                    alt="Ilustração de acesso do instrutor no Saberly" />
                            </div>
                        </div>
                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    ...
                                    <div class="text-center mb-4">
                                        <h5 class="">Área do Instrutor</h5>
                                        <p class="mb-0">Acesse sua conta para gerenciar seus cursos</p>
                                    </div>
