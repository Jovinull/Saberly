                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <h6>Selling Price</h6>
                                <span style="font-size: 17px">${{ $course->selling_price }}</span>
                            </li>

                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <h6>Discount Price</h6>
                                <span style="font-size: 17px">${{ $course->discount_price }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <h6>Resources</h6>
                                <span style="font-size: 20px">{{ $course->resources }}</span>
                            </li>
...
<script>
    $(document).ready(function () {
        // Delegation: evita problemas se algo for renderizado dinamicamente
